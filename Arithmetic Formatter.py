def arithmetic_arranger(problems, answer=False):
    ...
    # Create lists of oprands an operator
    ...
    # Builds first line 'width' of each calculation
    for i in range(len(first_operand)):
    ...
    # Builds second list with oprator and operand
    ...
    if answer:
     ...
     # Builds answer list, with formatting     
      ...
      # Joins all lists with new line formatting. If no answer, no fourth line
